...
import json
import sys
sys.path.append('/home/yzcheng/maai/TorchGRL')
...
class Experiment:
    ...
    def run(self, num_runs, training, testing, num_human, actual_num_human, num_cav, model, debug, num_merge_0=None,
        ...
        print('The model will be saved at: GRL_Trained_Models/DoubleDQN/DoubleDQN_3')
        save_dir = 'GRL_Trained_Models/DoubleDQN/DoubleDQN_3'
        ...
        # 进行模型测试
        test_episodes = 10
        load_dir = 'GRL_Trained_Models/DoubleDQN/DoubleDQN_3'
        debug_testing = False
        if testing:
